...
function_declarations	: FUNCTION IDENTIFIER LP formal_arguments RP COLON type {
...
conditional	: IF boolean_expression THEN {symbol_table.create();} description {	vector<vector<symbol_node> >::iterator it;
								it = symbol_table.symboltable.begin() + symbol_table.table_index;
								symbol_table.dump(symbol_table.table_index);
								symbol_table.symboltable.erase(it);}
					ELSE {symbol_table.create();} description END IF {	vector<vector<symbol_node> >::iterator it;
										it = symbol_table.symboltable.begin() + symbol_table.table_index;
										//cout << "number:::::: "<<symbol_table.table_index << endl;
										symbol_table.dump(symbol_table.table_index);
										symbol_table.symboltable.erase(it);
									}
		|IF boolean_expression THEN {symbol_table.create();} description END IF {
												vector<vector<symbol_node> >::iterator it;
												it = symbol_table.symboltable.begin() + symbol_table.table_index;
												symbol_table.dump(symbol_table.table_index);
												symbol_table.symboltable.erase(it);
...
loop	:  LOOP {symbol_table.create();} description END LOOP	{
								vector<vector<symbol_node> >::iterator it;
								it = symbol_table.symboltable.begin() + symbol_table.table_index;
								symbol_table.dump(symbol_table.table_index);
								symbol_table.symboltable.erase(it);
